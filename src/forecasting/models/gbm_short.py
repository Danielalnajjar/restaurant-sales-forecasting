"""GBM short-horizon model (H=1-14) with lag features."""
...
from forecasting.features.feature_builders import build_features_short
...
class GBMShortHorizon:
    ...
    def fit(self, df_train: pd.DataFrame):
        ...
        logger.info("GBM short-horizon training complete")
...
def run_gbm_short_backtest(
    train_data_path: str = "data/processed/train_short.parquet",
    ...
    output_metrics_path: str = "outputs/backtests/metrics_gbm_short.csv",
    output_preds_path: str = "outputs/backtests/preds_gbm_short.parquet",
    min_train_days: int = 120,
    step_days: int = 14,
) -> tuple:
    """Run rolling-origin backtest for GBM short-horizon model."""
    
    logger.info("Running GBM short-horizon backtest")
